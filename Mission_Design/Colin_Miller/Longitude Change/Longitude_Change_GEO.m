...
figure
plot(MJD-MJD(1), SC1_Long);
hold on
plot(MJD-MJD(1), SC2_Long);
plot(MJD-MJD(1), SC3_Long);

mean_long_SC1 = mean(SC1_Long)
mean_long_SC2 = mean(SC2_Long(PosSC2(1):PosSC2(3)))
mean_long_SC3 = mean(SC3_Long(PosSC3(1):PosSC3(3)))

title('Earth Longitude Of Stationary Satellites Over Time');
xlabel('Time (days)');
ylabel('Longitude (Degrees)');
legend('S/C_1 at 80', 'S/C_2 at -160', 'S/C_3 at -40');
