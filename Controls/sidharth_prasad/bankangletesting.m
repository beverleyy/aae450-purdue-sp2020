...
grid on;
title('Downrange vs. Altitude for Taxi (BC 200)');

%y(r,theta,phi,V,gamma,psi,s)
%Plotting various bank angles vs downranges
figure()
...
plot(y5(:,7)/1000,(y5(:,1)- 3389.5*10^3)/1000)
plot(linspace(0,1200),ones(100,1)*22);
plot(linspace(0,1200),zeros(100,1));
xlabel('Downrange (km)');
ylabel('Altitude (km)');
legend('Bank 0','Bank 180','Olympus Mons','Surface');
grid on;
